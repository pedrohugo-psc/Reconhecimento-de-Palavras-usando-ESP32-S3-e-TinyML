...
#define EI_CLASSIFIER_PROJECT_ID                 676052
#define EI_CLASSIFIER_PROJECT_OWNER              "Pedro Hugo Passos da Silva Carlos"
#define EI_CLASSIFIER_PROJECT_NAME               "Command_Voice_TCC"
