...
const char* ei_classifier_inferencing_categories[] = { "desconhecido", "dois", "ruido", "tres", "um", "zero" };
...
const ei_impulse_t impulse_676052_0 = {
    .project_id = 676052,
    .project_owner = "Pedro Hugo Passos da Silva Carlos",
    .project_name = "Command_Voice_TCC",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_676052_0 = ei_impulse_handle_t( &impulse_676052_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_676052_0;
